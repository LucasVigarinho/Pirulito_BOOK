...
/** Creating the class named Exercise_8_28 */
public class Exercise_8_28{
	...
	public static void main(String[] arg) {
		...
		/** Printed the answer */
		System.out.print("\n\n\t" + ((equals(matrix1, matrix2))?"The two arrays ARE strictly identical":"The two arrays ARE NOT strictly identical"));
