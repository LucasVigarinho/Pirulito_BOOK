...
/** Created the main class, using the name of the package (12) and the exercise (17) in a compose name */
public class Exercise_12_17 {
	
	/** Creating the main method 
	 * @throws FileNotFoundException */
	public static void main(String[] arg) throws FileNotFoundException, NoSuchElementException {
	 ...
	 * @throws FileNotFoundException */
	public static void startHangMan() throws FileNotFoundException {
	 ...
	 * @throws FileNotFoundException */
	public static void newGame(int category ) throws FileNotFoundException {
...
input.close();
	...
	public static String [] categoryGame(int category) throws FileNotFoundException{
